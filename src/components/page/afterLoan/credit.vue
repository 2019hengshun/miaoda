              ...
              <template slot-scope="props" >
                ...
                <el-table
                  ...
                  border 
                      highlight-current-row style="width: 100%;font-weight:bold"
                  >
                      <el-table-column fixed prop="id" label="id" align="center" sortable></el-table-column>
                       ...
                       <el-table-column prop="raiseMoney" label="提现金额" align="center" sortable></el-table-column> 
                        <el-table-column prop="return_money" label="本金和利率" align="center" sortable></el-table-column> 
                      <el-table-column prop="borrowTime" label="提现时间" align="center" sortable>
                        <template slot-scope="scope">
                            {{scope.row.creatime|dateServer}}
                        </template>                          
                      </el-table-column>
                      <el-table-column prop="status" label="本金还款状态" align="center" 
