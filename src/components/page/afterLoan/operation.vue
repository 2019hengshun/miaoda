              ...
              <template slot-scope="props" >
                ...
                <el-table
                  ...
                  >
                    ...
                    <el-table-column prop="overdue.returnMoney" label="本息金额" align="center" ></el-table-column>   
                      <el-table-column prop="returnMoney" label="总金额" align="center" >
                        <template slot-scope="scope">
                            {{scope.row.overdue.returnMoney+scope.row.overdue.penalty_money+scope.row.overdue.lateFee+scope.row.servicesMoney}}
                        </template>                           
                      </el-table-column>  
                      ...
                      >
                        <template slot-scope="scope">
                            ...
                            >{{scope.row.status===0?'放款中':scope.row.status===1?'放款成功':scope.row.status===2?'逾期':scope.row.status===3?'还款成功':scope.row.status===4?'放款失败':scope.row.status===5?'还款中':'还款失败'}}</el-tag>
                                             ...
                                             <el-table-column prop="servicesMoney" label="服务费" align="center" sortable></el-table-column>   
                        <el-table-column prop="overdue.penalty_money" label="逾期服务费" align="center" sortable></el-table-column>                       
                      ...
                      <el-table-column  prop="overdue.lateFee" label="线下还款申请情况" align="center" width="140" >
                        <template slot-scope="scope">
                            ...
                            >{{scope.row.loanRepaymentApplyId==1?'处理中':scope.row.loanRepaymentApplyId==2?'申请同意(完结)':scope.row.loanRepaymentApplyId==3?'申请拒绝(完结)':scope.row.loanRepaymentApplyId==4?'催收经理审核中':scope.row.loanRepaymentApplyId==5?'催收经理同意':scope.row.loanRepaymentApplyId==6?'催收经理拒绝':'未申请'}}</el-tag>
                        </template>   
                      </el-table-column>
