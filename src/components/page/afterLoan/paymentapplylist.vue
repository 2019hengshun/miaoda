    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="returnMoney" label="本息金额" align="center" min-width="120"  sortable></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handlehk(index, row) {
      ...
      this.editForm.yMoney = (
        Number(row.penalty_money) +
        Number(row.late_fee) +
        Number(row.charge_fee) +
        Number(row.returnMoney)
      ).toFixed(2);
