    ...
    <div class="container">
        ...
        <el-tabs v-model="activeName" type="border-card" class="m20" @tab-click="handleClick" v-loading="lodings">
          ...
          >
            ...
            <el-table-column prop="returnMoney" label="本息金额" width="120" align="center" sortable ></el-table-column>
            <el-table-column prop="overdue_day" label="逾期天数" width="120" align="center" sortable ></el-table-column>
            <el-table-column prop="penalty_money" label="逾期服务费" width="120" align="center" sortable ></el-table-column>
            <el-table-column prop="late_fee" label="滞纳金" width="110" align="center" sortable ></el-table-column>
            <el-table-column prop="charge_fee" label="服务费" width="110" align="center" sortable ></el-table-column>            
            <el-table-column prop="ned_return_money" label="应还款金额" width="180" align="center" sortable >
              <template slot-scope="scope">
                {{(scope.row.penalty_money+scope.row.returnMoney + scope.row.charge_fee + scope.row.late_fee).toFixed(2) }}
              </template>              
            </el-table-column>
          ...
          >
            ...
            <el-table-column prop="charge_fee" label="服务费" width="110" align="center" sortable ></el-table-column>               
            <el-table-column prop="ned_return_money" label="应还款金额"  width="120" align="center" sortable >
              <template slot-scope="scope">
               {{(scope.row.penalty_money+scope.row.returnMoney + scope.row.charge_fee + scope.row.late_fee).toFixed(2) }}
              </template>                
            </el-table-column>
