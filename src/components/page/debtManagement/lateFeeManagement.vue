<template>
 ...
 <el-row class="m20 col-flex-end" >                  
        ...
        <el-table
            ...
            v-loading="loading"
          >
            <el-table-column prop="userId" fixed label="用户ID" align="center" sortable width="120"></el-table-column>
            ...
            <el-table-column prop="return_money" label="本息金额" align="center" width="120" sortable></el-table-column>
     
            <el-table-column prop="late_fee" label="滞纳金额" align="center" width="120" sortable></el-table-column> 
            <el-table-column prop="charge_fee" label="手续费" align="center" width="120" sortable></el-table-column>
              <el-table-column prop="penalty_money" label="逾期服务费" align="center" width="120" sortable></el-table-column> 
                      <el-table-column prop="withdraw_charge_status" label="服务费还款情况" align="center" 
                      >
                        <template slot-scope="scope">
                            <el-tag
    ...
    <el-table-column prop="overdue_day" label="M值" align="center" width="80">
            ...
            <el-table-column prop="collectorName" label="本金还款状态" align="center"
      ...
      require.ensure([], () => {
        ...
        for (var i = 0; i < list.length; i++) {
          ...
          list[i].m = 
            ...
            list[i].overdue_day<11?'M1':
            list[i].overdue_day<21?'M2':
            list[i].overdue_day<31?'M3':
            'M3+';
          // list[i].M =
          //   list[i].M == 11
          //     ? ""
