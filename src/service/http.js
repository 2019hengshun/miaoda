...
//axios.defaults.baseURL = 'http://129.28.69.40:8084';
...
export function httpRateupdate(borrowDay, rateTotal, management_rate, liquidated_rate, serviceRateTotal) {
  let data = {
    borrowDay,
    rateTotal,
...
export function httpParameteradd(rateTotal, borrowDay, management_rate, liquidated_rate, serviceRateTotal) {
  let data = {
...
//后台管理模块 / 全部
export function httpLoanapply(loginId, npage, pagesize, userName, mobile, idNo, startDateString, finshDateString, channel) {
  let data = {
    loginId,
    npage,
    pagesize,
